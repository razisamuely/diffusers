...
class Fill50k(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        metadata_path = "data_a_f/metadata.json"
        images_dir = "/home/corsound/diffusers/examples/controlnet/data_a_f"
        conditioning_images_dir = "/home/corsound/diffusers/examples/controlnet/data_a_f"
